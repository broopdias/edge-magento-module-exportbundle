    ...
    public function exportAction()
    {
        ...
        if (count($products)) {
            try {
                ...
                if ($csv_export == '') {
                    $file = 'bundle';
                    $data_title = array('sku', 'website_ids', 'attribute_set_id', 'type_id', 'name', 'category_ids', 'has_options', 'sku_type', 'weight_type', 'shipment_type', 'status', 'price_type', 'price_view', 'special_price', 'is_in_stock', 'qty');
                ...
                foreach($products as $product) {
                    ...
                    $data = array($b_sku, $b_website_ids, $b_attribute_set_id, $b_type_id, $b_name, $b_category_ids, $b_has_options, $b_sku_type, $b_weight_type, $b_shipment_type, $b_status, $b_price_type, $b_price_view, $b_special_price, $b_is_in_stock, $b_qty);
